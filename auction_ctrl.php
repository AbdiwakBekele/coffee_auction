...
<!---------------------------Main Header-------------------------->
       <div id = "main-header">
           ...
           <div id = "searchArea">
               <form action = "">
                    <input class = "searchField" type = "text" name = "text" placeholder = "Search Here" autocomplete="off" required>
...
<div id = "auction_available">
    ...
    <article>
        <div id="auction_wrapper">
            ...
            <div id="auciton_btn">
                <div id="current_max">Current Maximum Offer:
                ...
                <form method="post" action="bid_result.php">
                    <input type="number"  name= "offer" placeholder="Your Offer in Birr" min = "<?php echo $max + 50;  ?>" required>
                ...
                <div id = "NB"> <u>NB</u>: The Offer should be 50 ETB ahead of the Current </div>
