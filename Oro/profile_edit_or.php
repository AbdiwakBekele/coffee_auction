            ...
            <div id="change_lang">
                ...
                <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="../profile_edit.php">English</a>
                            <a href="../Amh/profile_edit_am.php">አማርኛ</a>
                            <a href="profile_edit_or.php">Afaan Oromoo</a>
                            </div>
...
?>           
        ...
        <form method="post" action= profile_edit_or.php enctype='multipart/form-data'>
            <fieldset>
                <legend> Akkaawuntii Jijjiiruuf</legend>
                <div id="formElements">
                    ...
                    <label for= "profile_pic"> Suura Profile </label>
                    ...
                    <label for="pword">Jecha Darbii Duraa</label>
                    <input type="password" id="pword" name="pword_prev">
                    
                    <label for="pword">jecha Darbii Haaraa Galchi</label>
                    <input type="password" id="pword" name="pword">
                    
                    <label for="confirm_pword">Jecha Darbii Mirkaneessi </label>
                    ...
                    <div id="formBtns">
                        ...
                        <input type="submit" id="submitBtn" name="Submit" value="Jijjiiri">
