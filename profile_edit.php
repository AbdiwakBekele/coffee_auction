...
<div id = "navigationBar">
        <nav>
            <a href = "profile.php" id= "linkProfile">Profile</a>
            <a href = "#">Create Auction</a>
            <a href = "#">Bid on Others</a>
            <a href = "#">History</a>
            <a href = "#">Contact As</a>
        ...
        <form method="post" action= profile_edit.php enctype='multipart/form-data'>
            <fieldset>
                ...
                <div id="formElements">
                    ...
                    <label for="pword">Previous Password</label>
                    <input type="password" id="pword" name="pword_prev">
                    
                    <label for="pword">Create New Password</label>
                    <input type="password" id="pword" name="pword">
                    
                    <label for="confirm_pword">Confirm New Password</label>
