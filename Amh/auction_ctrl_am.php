...
<div id = "auction_available">
    <div id="auction_header">
        <h1>ለጫራታ የቀረበ</h1>
        <a href = "bid_on_other.php" id="back_link">ተመለስ</a>
    </div>
    ...
    <article>
        <div id="auction_wrapper">
            ...
            <div id="auciton_btn">
                <div id="current_max">የተሰጠ ከፍተኛ ዋጋ:
                ...
                <div id = "NB"> <u>ማሳሰብያ</u>:  የሚሰጡት ዋጋ መጀመሪያ ከተሰጠ ዋጋ በ 50 ብር መብለጥ አለበት  </div>
